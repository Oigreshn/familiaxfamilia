<x-guest-layout>
    <div class="mb-4 text-sm text-gray-600 text-justify">
        ...
        ¿Podría verificar su dirección de correo electrónico haciendo clic en el enlace 
        que le acabamos de enviar por correo electrónico? 
    ...
    @if (session('status') == 'verification-link-sent')
        <div class="mb-4 font-medium text-sm text-green-600 text-justify">
            {{ __('Se ha enviado un nuevo enlace de verificación a la dirección de 
